...
class FindResultList extends Component {
    ...
    getData(){
        ...
        const schWord = this.props.match.params.name;
        console.log(schWord);

        axios.get('/findreport/'+schWord).then(response => {
            this.setState({
                items: response.data
            });
        })
            ...
            <div className='container'>
                ...
                <div className='row justify-content-center'>
                    <div className='col-md-12'>               
                        ...
                        <br /><br />
                        <center><h1>FICHARS {this.props.match.params.name.toUpperCase()}</h1></center>
