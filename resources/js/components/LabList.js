...
class LabList extends Component {
    ...
    getData(){
         ...
         axios.get('/users/list/Lab').then(response => {
            this.setState({
                items: response.data
            });
        }) 
                    ...
                    <div className='col-md-12'>               
                        ...
                        <table className="table table-hovered table-striped" style={this.tableStyle}>
                            ...
                            {this.state.items.map((item,i)=>(
                                <tr key={i}>
                                    ...
                                    <td>
                                        <Link className='btn btn-info'  to={`/labs/${item.id}/edit`} key={item.id}>Edit</Link>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-2">
                                <Link className='btn btn-primary' to='/labs/create' style={this.registerStyle}>AGREGAR</Link>
                            </div>
                            <div className="col-lg-5"></div>
                        </div>
                    </div>
